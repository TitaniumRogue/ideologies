...
NDiplomacy = {
	...
	JOIN_FACTION_LIMIT_CHANGE_AT_WAR = 0.0,			-- if in defensive war this or your modifier is counted as limit to join factions (so if you have 80% join limit this now means you can join at 50%)
...
NAI = {
	...
	DIPLOMACY_FACTION_NEUTRALITY_PENALTY = 5,	-- Neutral nations have a separate penalty, not wanting to get involved at all, rather than caring much about the difference in ideology
